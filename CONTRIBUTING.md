...
- When [reporting a bug](https://github.com/laser-base/laser-generic/issues) please include details, such as your operating system and the exact steps to reproduce the issue.
...
- The best way to send feedback on LASER is to [file an issue](https://github.com/laser-generic/laser-core/issues).
