...
- **"Simulated Total Population"** (blue, solid): $S+E+I+R$ from the temporal-CBR model.
- **"Expected Growth (Time-varying CBR)"** (orange, dashed): computed by stepping the analytic per-day compounding factor $(1 + \text{CBR}_t/1000)^{1/365}$ forward through the same 3650-day CBR ramp.
