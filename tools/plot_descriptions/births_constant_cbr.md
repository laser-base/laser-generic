...
- **Blue solid — simulated total population** $S+E+I+R$ aggregated across the single node.
- **Orange dashed — expected growth** under the analytic compound-interest formula $N_0(1 + \text{CBR}/1000)^{t/365}$ with $\text{CBR}=20$ per 1000 per year.
