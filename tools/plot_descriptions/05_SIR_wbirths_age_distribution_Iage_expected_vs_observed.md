...
All 25 points sit tightly on the identity line across the full 0.73-2.33 year range. The accompanying printout shows the average fractional deviation, max deviation, and counts of runs exceeding 5% and 10% error — the verbal pass/fail criteria for the test.
