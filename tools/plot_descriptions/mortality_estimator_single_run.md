...
- **Blue — Susceptible (S).** Starts at ~37,500 and decays gently and roughly linearly to ~33,500 by day 3650, a shallower slope than under the constant-CDR run.
- **Orange E** and **red I.** Same transient SEIR pipeline behavior: a brief spike in the first ~80 days (red I peaks near 14,000), then both fall to zero.
- **Green — Recovered (R).** Rises to a peak near 62,000 by day ~80, then declines to ~55,800 by day 3650 — again, less steeply than the constant-CDR analog.
