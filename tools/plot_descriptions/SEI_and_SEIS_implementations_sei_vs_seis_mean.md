...
- **Exposed (green).** **"SEI Mean Exposed"** (solid) produces a transient pulse peaking ~215,000 around day 80, returning to zero by day ~120. **"SEIS Mean Exposed"** (dashed) peaks slightly later (~225,000) and instead of decaying settles to ~205,000.
- **Infectious (orange).** **"SEI Mean Infectious"** (solid) sigmoidally climbs to the absorbing $10^6$ saturation by day ~100. **"SEIS Mean Infectious"** (dashed) peaks near ~600,000, then dips slightly and settles at the endemic ~580,000.
