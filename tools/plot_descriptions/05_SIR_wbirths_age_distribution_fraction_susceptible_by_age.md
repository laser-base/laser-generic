...
- **"Expected exponential distribution - A = 1.071 years"** (orange, solid, thick): the analytic curve $e^{-a \mu (R_0-1)}$ with mean $A = \frac{1}{\mu(R_0-1)}$.
- **"Best fit mean age of susceptibility, A = 1.016 years"** (black, dashed): the exponential fit to the simulation data.
